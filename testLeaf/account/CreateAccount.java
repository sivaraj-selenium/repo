...
public class CreateAccount {
	...
	public static void main(String[] args) {
		...
		accName.sendKeys("sivaTest"+UUID.randomUUID());
		...
		String accountname = obj.findElement(By.className("tabletext")).getText();
		System.out.println("1st" + accountname);
		WebElement a = obj.findElement(By.className("tabletext"));
		String second = a.getText();
